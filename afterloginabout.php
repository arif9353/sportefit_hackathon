  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        ...
        <p class="leading-relaxed text-lg"><p class="leading-relaxed text-lg">Fitness is not only about how you look on the outside but the strength within to walk with confidence and have the tools to live a long, healthy, and purposeful life.<br>Change your lifestyle, you'll feel happier, improve your energy, and build yourself physically and mentally from a program you can stick to for a lifetime.<Br>Musclebreak provides more than another workout as we help you to have a comprehensive approach to fitness. We pair the ultimate strength and cardio workouts with experiential lighting, sound, and luxury amenities. <br>Achieve your desired fitness goals with a mix of HIIT, Cycle, Barre, Row, Yoga, and more. <br>Our coaches are passionate and supportive, and our studio is outfitted with innovative lighting and sound systems to fuel your workout.<br>We reshape bodies and minds to bring out the max potential in all of us.<br> WE BELIEVE IN YOU, ALWAYS</p></p>
        <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
        <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">~TEAM Sportèfit</h2>
