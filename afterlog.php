...
<header class="text-gray-600 body-font" style="margin-bottom: 0px; background-color: rgb(228, 243, 255);">
  ...
  <?php endif ?>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img class="object-cover object-center rounded" alt="hero" src="sportefit.png">
    </div>
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">YOU CAN ALWAYS LOOK BETTER, THINNER & STRONGER
      </h1>
      <p class="mb-8 leading-relaxed">Get in shape with the help of our expert fitness trainers. 
        <br>Sportèfit provides all the services that you can think of!
        <br>So avail them as soon as possible at reasonable and be a better version of yourself. </p>
    </div>
  </div>
      </section>
