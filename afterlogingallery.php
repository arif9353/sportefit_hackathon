    ...
    <div class="flex flex-wrap md:-m-2 -m-1">
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-1/2">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/500x300/?gym">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/501x301/?gym">
              </div>
              <div class="md:p-2 p-1 w-full">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/600x360/?gym">
              </div>
            </div>
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-full">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/601x361/?gym">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/502x302/?gym">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="content" class="object-cover object-center h-full w-full" src="https://source.unsplash.com/503x303/?workout,gym">
              </div>
            </div>
          </div>
          </div>
